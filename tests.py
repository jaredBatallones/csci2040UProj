...
class DatabaseTests(unittest.TestCase):
    def setUp(self):
        ...
        furniture.add_furniture(self.connection, self.cursor, 1, "Couch", "Red", 99.99, "Medium", "B5")
        furniture.add_furniture(self.connection, self.cursor, 2, "Chair", "Brown", 100.99, "Medium", "A2")
        login.initialize_users(self.connection, self.cursor)

    def test_UT_01_CB_add_furniture(self):
        new_furniture = furniture.Furniture(3, "Table", "Black", 150.00, "Large", "C4")
    ...
    def test_UT_02_CB_sort_by_type(self):
        ...
        expected_list = [furniture.Furniture(2, "Chair", "Brown", 100.99, "Medium", "A2"), furniture.Furniture(1, "Couch", "Red", 99.99, "Medium", "B5")]
    ...
    def test_UT_03_CB_sort_by_price(self):
        ...
        expected_list = [furniture.Furniture(1, "Couch", "Red", 99.99, "Medium", "B5"), furniture.Furniture(2, "Chair", "Brown", 100.99, "Medium", "A2")]
        for i in range(len(expected_list)):
            self.assertEqual(sorted_list[i], expected_list[i], "Sort by price failed")
        db.closeDatabase(self.connection)

    def test_UT_04_CB_modify_furniture(self):
        furniture.update_furniture(self.connection, self.cursor, 1, "Couch", "Blue", 120.00, "Medium", "B5")
        database_furniture_list = furniture.get_furniture_list(self.cursor)
        expected_furniture = furniture.Furniture(1, "Couch", "Blue", 120.00, "Medium", "B5")
    ...
    def test_UT_05_CB_search_keyword(self):
        ...
        expected_list = [furniture.Furniture(1, "Couch", "Blue", 120.00, "Medium", "B5")]
    ...
    def test_UT_06_CB_remove_furniture(self):
        ...
        database_furniture_list = furniture.get_furniture_list(self.cursor)
        self.assertEqual(len(database_furniture_list), 2, "Furniture removal failed - wrong count")
        self.assertNotIn(furniture.Furniture(1, "Couch", "Red", 99.99, "Medium", "B5"), database_furniture_list, "Furniture not removed")
        db.closeDatabase(self.connection)
    ...
    def test_UT_10_CB_login_validation_failure(self):
        user = login.attemptLogin(self.cursor, "999", "wrongpass")
        self.assertIsNone(user, "Invalid login should return None")
        db.closeDatabase(self.connection)

    def test_UT_11_CB_add_furniture_duplicate(self):
        result = furniture.add_furniture(self.connection, self.cursor, 1, "Table", "Black", 150.00, "Medium", "B5")
    ...
    def test_IT_02_CB_gui_to_database(self):
      ...
      furniture.add_furniture(self.connection, self.cursor, 3, "Table", "Black", 150.00, "Large", "C4")
      database_furniture_list = furniture.get_furniture_list(self.cursor)
      expected_furniture = furniture.Furniture(3, "Table", "Black", 150.00, "Large", "C4")
