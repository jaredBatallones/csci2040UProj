...
class Furniture:
    ...
    def get_furniture_id(self): return self.furniture_id
    def set_furniture_id(self, furniture_id): self.furniture_id = furniture_id
    ...
    def get_aisle(self): return self.aisle
    def set_aisle(self, aisle): self.aisle = aisle
...
def get_furniture_list(cursor):
    ...
    return [Furniture(*row) for row in raw_stuff]
